...
-- run command: th mytest.lua

print("loading model")
--filename = '/scratch0/sem4/cmsc702/deepSEA/deepSEA_orig/DeepSEA/results_3000000/model/bestmodel.net'
--filename = '/scratch0/sem4/cmsc702/deepSEA/deepSEA_orig/DeepSEA/results_3000000_prelu/model/bestmodel.net'
filename = '/scratch0/sem4/cmsc702/deepSEA/DeepSEA-v0.94/deepsea.cpu'
...
--Save predictions
f=hdf5.open( 'testmat_pretrainedmodel' .. '.pred' .. '.h5', 'w')
