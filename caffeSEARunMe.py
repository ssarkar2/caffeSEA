...
if __name__ == '__main__':
    ...
    if op == 0:
        ...
        evaluateModel(dataDir + 'Model/model_defn_new.prototxt' ,'/scratch0/sem4/cmsc702/deepSEA/deepSEA_caffe/dumpModels/caffeSEAFull__iter_80.caffemodel', dataDir + 'hdf5FullInputDir/test.txt', 'runlog.txt')
